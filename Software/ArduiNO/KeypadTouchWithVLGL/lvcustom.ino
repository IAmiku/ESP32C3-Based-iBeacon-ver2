...
void lvcustom(void)
{
    ...
    t1 = lv_tabview_add_tab(tv, "BUS ID");
    t2 = lv_tabview_add_tab(tv, "SETTING");
...
static void msgbox_create(void)
{
    ...
    lv_obj_t * mbox = lv_msgbox_create(NULL, "Hi", "Welcome to the Shuttle Tracker Nodes v0.1", btns, false);
