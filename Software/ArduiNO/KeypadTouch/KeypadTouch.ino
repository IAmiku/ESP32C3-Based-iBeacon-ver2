...
if(Brightness==255){Up=false;}else if(Brightness=0){Up=true;}
if(Up){Brightness++;}else{Brightness--;}
  neopixelWrite(8,Brightness,Brightness,Brightness); // Red
  }
...
void touch_calibrate()
{
  ...
  if (calDataOK && !REPEAT_CAL) {
    ...
    Serial.println("data not valid so recalibrate");
