...
void setup() {
  ...
  digitalWrite(2, HIGH); // Touch controller chip select (if used)
  digitalWrite(3, HIGH); // TFT screen chip select
...
void loop() {
  ...
  drawSdJpeg("/test.jpg", x, y);     // This draws a jpeg pulled off the SD Card
  delay(2000);
